...
#### 💼 [Coaching Institute Website](https://github.com/Ishan71845/internship)
Full Stack Website for the  Coaching Institute as an Project Based Internship.
- **Tech:** Node.js, Express, MongoDB, Reactjs, Postman
- **Features:** Landing Page, Admin Dashboard having leads generated from Application Forms
- **Role:** Full-stack developer

#### 🤖 [Competitive Analysis Agent](https://github.com/Ishan71845/competitive-analysis-agent)
AI-powered agent built with Google's Gemini ADK for automated competitive analysis.
- **Tech:** Python, Google Gemini ADK, Multi-agent systems
- **Features:** Automated research, data synthesis, report generation
...
- 🎓 **Advanced Blockchain Development** - Coursera
- 🏅 **Hackathon Participant** - ISRO, Google Agentic AI, Smart India Hackathon
- 🔒 **Smart Contract Developer** - Cyfrin Updraft
...
I'm actively contributing to open source projects and preparing for **Google Summer of Code 2026**. I'm particularly interested in projects involving:
- 🔗 Blockchain infrastructure and DeFi protocols
- 🌐 Decentralized applications and Web3 tools
- ⚛️ Full-stack JavaScript/TypeScript projects
- 🤖 AI-powered applications and automation tools

**Looking for collaboration opportunities and open to contributing to interesting projects!**
